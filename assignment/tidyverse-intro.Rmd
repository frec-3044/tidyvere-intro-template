...
Write the data frame you created for answering Question 14 (not the entire dataset) to your repo top-level directory with the filename of `introduction-cleaned-data.csv`.  Hint use [`write_csv()`](https://r4ds.hadley.nz/data-import.html#sec-writing-to-a-file)
