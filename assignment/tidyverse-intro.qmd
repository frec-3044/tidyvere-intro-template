...
Read the data file into R. This file is directly streamed into R memory from a URL, rather than downloaded and saved locally.  Reading from the orginal sources ensures that you are working with latest and unaltered version
