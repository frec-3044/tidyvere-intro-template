...
Exercise 2 is focused on cleaning up the full dataset.  Initially, you will use the full dataset (`df`). Then, you will use the `filter`, `select`, `rename`, and `mutate` functions.
