...
The column name `Flag_Chla_ugL` is a bit long [Rename](https://r4ds.hadley.nz/data-transform.html#rename) the column to `flag`.  Then `filter` the dataset to only include high quality data (flag is 0) 
