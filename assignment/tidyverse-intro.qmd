...
The Reservoir column is different reservoirs in the Roanoke, VA area where a set of water quality variables have been measured.
...
Read the data file into R. This file is directly streamed into R memory from a URL, rather than downloaded and saved locally.  Reading from the original sources ensures that you are working with the latest and unaltered version
